 ...
 */
    ...
    export class ProjectService {
                    ...
                    if (lazyConfiguredProjectsFromExternalProject && !this.hostConfiguration.preferences.lazyConfiguredProjectsFromExternalProject) {
                        ...
                        this.configuredProjects.forEach(project => {
                            if (project.hasExternalProjectRef() &&
                                ...
                                this.loadConfiguredProject(project, "Host configuration for lazy loading configured project changed");
                                project.updateGraph();
                            }
                        });
                    }
        ...
        getOriginalLocationEnsuringConfiguredProject(project: Project, location: sourcemaps.SourceMappableLocation): sourcemaps.SourceMappableLocation | undefined {
            ...
            const configuredProject = this.findConfiguredProjectByProjectName(configFileName) || this.createAndLoadConfiguredProject(configFileName, `Creating project for original file: ${originalFileInfo.fileName} for location: ${location.fileName}`);
